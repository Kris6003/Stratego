...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    public MenuPrincipal(int indexUser, ArrayList<UsuariosInfo> listaUsuariosExterna, ArrayList<LogsInfo> listaLogsExterna, String nombreUsuario, ArrayList<UsuariosEliminadosInfo> listaUsuariosEliminadosExterna, boolean ModoJuego) {
    ...
    private void BotonConfiguracionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonConfiguracionMouseClicked
        Configuracion configuracion = new Configuracion(indexUser,listaUsuarios, this.listaLogs, nombreUsuario,this.listaUsuariosEliminados,modoTutorial);
    ...
    private void BotonMiPerfilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonMiPerfilMouseClicked
        MiPerfil miPerfil = new MiPerfil(indexUser,this.listaUsuarios, this.listaLogs, nombreUsuario,this.listaUsuariosEliminados,modoTutorial);
    ...
    private void BotonUniversoMarvelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonUniversoMarvelMouseClicked
        UniversoMarvel universoMarvel = new UniversoMarvel(indexUser,listaUsuarios, listaLogs, nombreUsuario,listaUsuariosEliminados,modoTutorial);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuPrincipal(-1,null, null, null,null,true).setVisible(true);
            }
        });
    }
