...
public class UniversoMarvel extends javax.swing.JFrame {
    ...
    public UniversoMarvel(int indexUser, ArrayList<UsuariosInfo> listaUsuariosExterna, ArrayList<LogsInfo> listaLogsExterna, String nombreUsuario, ArrayList<UsuariosEliminadosInfo> listaUsuariosEliminadosExterna, boolean ModoJuego) {
    ...
    private void BotonRegresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonRegresarMouseClicked
        MenuPrincipal menuPrincipal = new MenuPrincipal(indexUser,listaUsuarios,listaLogs, usuarioGPerfil,listaUsuariosEliminados,modoTutorial);
    ...
    private void BotonRankingMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonRankingMouseClicked
        Ranking ranking = new Ranking(indexUser,listaUsuarios,listaLogs, usuarioGPerfil,modoTutorial);
    ...
    private void BotonBatallasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonBatallasMouseClicked
        Batallas batallas = new Batallas(indexUser,this.listaUsuarios,this.listaLogs, usuarioGPerfil,listaUsuariosEliminados,modoTutorial);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UniversoMarvel(-1,null,null,null,null,true).setVisible(true);
            }
        });
    }
